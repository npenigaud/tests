program testmm
        ...
        !$acc parallel vector_length(32) private(tailleligne,taillecolonne,i,j,k,m,n,ligne,colonne,coeff)
          ...
          do n=1,100,128 
            ...
            do i = 1,64
              ...
              do k=1,100
                ...
                do j=1,128 
                  ligne=n+j-1
                  if ((colonne.LE.100000).AND.(ligne .LE. 100)) v2(ligne,colonne)=v2(ligne,colonne)+a(ligne,k)*coeff
                enddo
              enddo
            enddo
          enddo        
