program testmm
        ...
        double precision, dimension(longueur,2*longueur)::inter
        ...
        !$acc cache(inter2(longueur,longueur),inter(longueur,64))
        !$acc loop gang 
        do i = 1, 100000,32*2
          !$acc loop vector
          do j=1,32 
          ...
          indice2=i+32*(j2-1)
                ...
                indice=indice2+j-1
                inter(j,1:32)=v1(j,indice2:indice2+32)
                inter2(j,:)=a(j,:)
          ...
          indice2=i+32*(j2-1)
                ...
                indice=indice2+j-1
                inter(j,33:64)=v1(j,indice2:indice2+32)
