...
!$acc kernels
h_send(1:4)=liste%sc1(1)%tA(1:4)
!$acc end kernels
print *,"h_recv ",h_recv(1)
print *,"h_send ",h_send(1)
...
!$acc kernels
liste%sc1(2)%tA(1:4)=h_recv(1:4)
print *,"liste sc1(1) psp ==> ",liste%sc1(1)%tA(1)
print *,"liste sc1(2) psp ==> ",liste%sc1(2)%tA(1)
print *,"tabl1 sur carte ==> ",tabl1(1)
print *,"tabl3 sur carte ==> ",tabl3(1)
print *,"h_recv ",h_recv(1)
print *,"h_send ",h_send(1)
!$acc end kernels
